...
from maze_app.generator.generator import PrimGenerator, ImperfectGenerator
...
def main():
    ...
    try:
        ...
        seed, perfect = None, True

    if seed is not None:
        random.seed(seed)

    maze = Maze(height, width, entry, exit_pos)
